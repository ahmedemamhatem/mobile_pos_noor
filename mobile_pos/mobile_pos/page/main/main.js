frappe.pages['main'].on_page_load = async function(wrapper) {
    ...
    // ==================== Ramadan Welcome Animation ====================
    (function showRamadanWelcome() {
        if (!frappe.session.user || frappe.session.user === 'Guest') return;

        // Show only once per session
        const sessionKey = 'ramadan_welcome_shown';
        ...
        const overlay = $(`
            <div class="ramadan-overlay">
                <div class="ramadan-container">
                    <div class="ramadan-stars">
                    ...
                    <div class="ramadan-text">
                        ...
                        <div class="ramadan-welcome">&#1571;&#1607;&#1604;&#1575;&#1611; ${userName}</div>
                        <div class="ramadan-dua">&#1575;&#1604;&#1604;&#1607;&#1605; &#1576;&#1604;&#1594;&#1606;&#1575; &#1585;&#1605;&#1590;&#1575;&#1606; &#1608;&#1571;&#1606;&#1578; &#1585;&#1575;&#1590;&#1613; &#1593;&#1606;&#1575;</div>
                    </div>
                    <div class="ramadan-mosque">&#128332;</div>
                </div>
            </div>
            <style>
                .ramadan-overlay {
                    ...
                    z-index: 99999;
                    background: radial-gradient(ellipse at center, rgba(10,22,40,.85) 0%, rgba(3,9,18,.85) 60%, rgba(0,2,5,.85) 100%);
                    backdrop-filter: blur(6px); -webkit-backdrop-filter: blur(6px);
                    display: flex;
                    align-items: center;
                    justify-content: center;
                    animation: ramadanFadeIn 0.6s ease;
                    overflow: hidden;
                }
                .ramadan-container {
                    text-align: center;
                ...
                .ramadan-moon {
                    font-size: 90px;
                    animation: moonRise 1.2s cubic-bezier(0.34, 1.56, 0.64, 1) both;
                    filter: drop-shadow(0 0 30px rgba(255, 215, 0, 0.6));
                    margin-bottom: 10px;
                }
                .ramadan-text {
                    animation: textAppear 0.8s ease 0.6s both;
                }
                .ramadan-greeting {
                    font-size: 42px;
                    font-weight: 900;
                ...
                .ramadan-dua {
                    ...
                    font-weight: 600;
                    font-family: 'Cairo', 'Amiri', serif;
                    animation: duaGlow 2s ease-in-out infinite alternate;
                }
                .ramadan-mosque {
                    font-size: 50px;
                    margin-top: 20px;
                    animation: mosqueAppear 0.8s ease 1s both;
                ...
                .lantern.l2 { animation-delay: 0.5s; }
                .lantern.l3 { animation-delay: 1s; }
                .ramadan-stars {
                    position: absolute;
                    top: 0; left: 0; right: 0; bottom: 0;
                    pointer-events: none;
                ...
                .s1 { top: 5%; left: 10%; font-size: 14px; animation-delay: 0s; }
                .s2 { top: 15%; right: 15%; font-size: 10px; animation-delay: 0.3s; }
                .s3 { top: 8%; left: 40%; font-size: 8px; animation-delay: 0.7s; }
                .s4 { top: 20%; left: 25%; font-size: 12px; animation-delay: 1.1s; }
                .s5 { top: 3%; right: 30%; font-size: 16px; animation-delay: 0.5s; }
                .s6 { top: 25%; right: 8%; font-size: 9px; animation-delay: 1.4s; }
                .s7 { top: 12%; left: 60%; font-size: 11px; animation-delay: 0.9s; }
                .s8 { top: 18%; right: 45%; font-size: 13px; animation-delay: 1.7s; }
                ...
                @keyframes moonRise {
                    from { transform: translateY(60px) scale(0.3); opacity: 0; }
        ...
        setTimeout(() => {
            overlay.find('.ramadan-overlay').css('animation', 'ramadanFadeOut 0.8s ease forwards');
            setTimeout(() => overlay.remove(), 800);
        }, 3500);

        // Click to dismiss
        overlay.on('click', function() {
            overlay.find('.ramadan-overlay').css('animation', 'ramadanFadeOut 0.5s ease forwards');
